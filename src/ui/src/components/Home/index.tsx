...
import { LogoWrapper, Container, BackgroundImage, FormInput, WrapperContainer } from './styles';
...
export const Home = (props: any) => {
  ...
  const styles = StyleSheet.create({
    ...
    btn: {
      borderRadius: 7.6,
      marginTop: 20,
        maxHeight:  Platform.OS === 'android' ?  60 : 44,
    },
    btnText: {
      fontFamily: 'Poppins',
      fontStyle: 'normal',
  ...
  return (
    <Container height={windowHeight - safeHeight} orientation={orientation}>
      ...
      > */}
        <WrapperContainer>
          <LogoWrapper>
            <OIcon src={theme?.images?.logos?.logo} style={styles.logo} />
          </LogoWrapper>

          <View style={styles.wrapperContent}>
            <View style={styles.wrapperText}>
              <OText style={styles.textTitle} color={theme.colors.logintext}>
                {t('TITLE_SIGN_UP', 'Welcome')}
              </OText>

              <OText style={styles.textSubtitle} color={theme.colors.logintext}>
