...
const InsuranceDetailsUI = (props: any) => {
  const {
    stateDetails
  } = props
  const [, t] = useLanguage();
  ...
  let { ondriverInsuranceModal, driverinsuranceUpload, onclosevehicleModal, driverlicenseimageUpload, ondriverlisenceModal, driverlisenc, formstate } = props;
    ...
    <>
      ...
      <ScrollView>
        ...
        <View style={[styles?.container,
          ...
          <Text style={{ ...styles.title_txt, color: theme?.colors.logintext, paddingTop: moderateScale(0) }}>{t('ADD_DRIVER_LICENSE', 'Add your driver’s license')}</Text>

          <Text style={{ ...styles.inputTitle_txt, color: theme?.colors.logintext }}>{t('DRIVER_LICENSE_NUMBER', 'Driver’s License Number')}</Text>

          <TextInput
            value={formstate?.driver_license?.lisencenumber}
            onChangeText={(t) => driverlisenc('lisence_number', t)}
            placeholder={t('LICENSE_NUMBER', 'License Number')}
          ...
          <View style={styles.main_view}>
            <View>
              ...
              {/* <TextInput
                  value={formstate?.driver_license?.state}
                  onChangeText={(t) => driverlisenc('state', t)}
              ...
              <SelectDropdown
                ...
                onSelect={(selectedItem: any) => {
                  driverlisenc('state', selectedItem.value)
                  console.log("Selected State:", selectedItem.value);
                }}
                defaultButtonText={t('SELECT_A_STATE', 'Select')}
            ...
            <View >
              ...
              <DatePicker
                ...
                onConfirm={(selectedDate) => {
                  ...
                  driverlisenc('date', selectedDate)
          ...
          <TouchableOpacity
            onPress={() => driverlicenseimageUpload()}
            style={{ ...styles.photoinput_sty, backgroundColor: theme?.colors.loginInputbackground }}>
            <ImageBackground
              source={{ uri: formstate?.driver_license?.image }}
              style={{
                ...styles.photoinput_sty,
          ...
          <View style={{
            ...
            <OButton
              onClick={() => {
                props?.navigation?.navigate('CustomerInsurance')
                // ondriverInsuranceModal(),
                //   ondriverlisenceModal()
              ...
              // }}
              isDisabled={
                formstate?.driver_license?.lisencenumber != '' &&
                  formstate?.driver_license?.state != ''
                  ? false : true
...
export const CustomerLisence = (props: any) => {

  const SignupUserDetailsProps = {
    ...props,
    UIComponent: InsuranceDetailsUI
  }
  return (
    <>
      <SafeAreaContainerLayout>
