...
import { Modal, StyleSheet, SafeAreaView, View, TouchableOpacity, Platform } from 'react-native';
          ...
          <>
            {!customClose && (
              <View style={styles.titleSection}>
                <View style={Platform.OS === 'android' ? styles.titleGroupsa : styles.titleSection}>
