...
import { OAlertOriginal as Alert, OIconButton, OIcon, OFab, OText, OButton, FloatingButton, useLocation } from '@ui'
    ...
    <SafeAreaView style={{ flex: 1 }}>
      <View style={{ flex: 1 }}>
        ...
        <OFab
          ...
          style={{
            position: 'absolute',
            bottom: showAcceptOrReject
              ? Platform.OS === 'ios' ? 115 : 215
              : 75,
            right: 20,
          }}
        />
