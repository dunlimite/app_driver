...
import { useLanguage, useUtils, WebsocketStatus as WebsocketStatusController } from '@components'
...
const SocketStatusUI = (props: any) => {
  ...
  return (
    <Container>
      ...
      >
        <OText
          style={{ color: theme.colors.backArrow, fontSize: 15, marginBottom: 0, lineHeight: 16 }}
        >
