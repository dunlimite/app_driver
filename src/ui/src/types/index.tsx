...
export interface OrderDetailsParams {
  ...
  handleChangeOrderStatus?: (status: any, isAcceptOrReject: any, val?: any) => {};
  order?: any;
  isFromRoot?: any;
  handleOrderRedirect?: () => {};
  setMessages?: () => {};
...
export interface AcceptOrRejectOrderParams {
  ...
  action: string;
  orderId?: number;
  handleUpdateOrder?: (p1?: any, p2?: any, p3?: any) => void;
