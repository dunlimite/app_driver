...
import { ProductIngredient } from 'ordering-ui-native-release/themes/original';
import { ProductOption } from 'ordering-ui-native-release/themes/original';
...
import { OButton, OIcon, OInput, OText } from 'ordering-ui-native-release/themes/original';
import { ScrollView } from 'react-native-gesture-handler';
import { ProductOptionSubOption } from 'ordering-ui-native-release/themes/original';
import { NotFoundSource } from 'ordering-ui-native-release/themes/original';
import { Placeholder, PlaceholderLine, Fade } from 'rn-placeholder';
import NavBar from '../NavBar';
import { orderTypeList } from '../../utils_ch';
...
export const ProductOptionsUI = (props: any) => {
	...
	const handleSaveProduct = () => {
		...
		if (!isErrors) {
			props.route.params?.handelOpenShowOrd();
		...
		<SafeAreaView style={{ flex: 1 }}>
			<View style={styles.wrapperNavbar}>
				<TopHeader>
					<>
						<TopActions onPress={() => {
						  props.route.params?.handelCloseShowOrd();
						  handleGoBack();
						}}>
							<IconAntDesign
								name='arrowleft'
