...
import { PaymentOptionGreenPayv2 as PaymentOptionGreenPayv2Controller } from '../PaymentOptionGreenPayv2Controller'
...
const PaymentGreenPayV2CardlistUI = (props: any) => {
	const {
		onSelectCard,
		redSysDeleteCardnew,
		cardSelected,
...
export const PaymentGreenPayV2Cardlist = (props: any) => {
	const paymentGreenPayV2CardlistProps = {
		...props,
		UIComponent: PaymentGreenPayV2CardlistUI
	}
	return (
		<PaymentOptionGreenPayv2Controller {...paymentGreenPayV2CardlistProps} />
	)
}
