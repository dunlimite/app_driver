...
import { OButton, OIcon, OModal, OText,  } from 'ordering-ui-native-release/themes/original'
import  OModalCourier  from '../shared/OModalCourier'
import Alert from '../../providers/AlertProvider'
import { BusinessBasicInformation } from 'ordering-ui-native-release/themes/original'
import { SearchBar } from 'ordering-ui-native-release/themes/original'
import { BusinessProductsCategories } from 'ordering-ui-native-release/themes/original'
import { BusinessProductsList } from 'ordering-ui-native-release/themes/original'
...
import { ProfessionalFilter } from 'ordering-ui-native-release/themes/original';
import { ServiceForm } from 'ordering-ui-native-release/themes/original';
import { BusinessesListing } from 'ordering-ui-native-release/themes/original'
import { PageBanner } from 'ordering-ui-native-release/themes/original'
import { NavBack } from 'ordering-ui-react-native/src/components/OrderDetails/styles';
import { OrderTypeSelectorCourier } from '../OrderTypeSelectorCourier';
...
const BusinessProductsListingUI = (props: BusinessProductsListingParams) => {
  ...
  const handleUpsellingPage = (cart: any) => {
  	if(businessState?.business?.courierbus === true){
		setShowPickupAddress(true)
		return;
	}else{
  ...
  return (
    <>
        ...
        {viewOrderButtonVisible && (
          <View style={{ marginBottom: 0 }}>
            <FloatingButton
              ...
              disabled={subtotalWithTaxes < currentCart?.minimum || openUpselling || orderState?.loading}
			  handleClick={
						orderState?.loading
      ...
      >
        ...
        <OrderTypeSelectorCourier
          configTypes={configTypes}
		  handleUpdateOrderType={handleUpdateOrderType}
        />
