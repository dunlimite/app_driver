...
const AddressFormUI = (props: AddressFormParams) => {
	...
	const [pickupdate, setPickupdate] = useState(addressState?.address?.pickupdate ?? null)
	const [showDatePicker, setShowDatePicker] = useState(false)
	
	const [pickuptime, setPickupTime] = useState(
    addressState?.address?.pickuptime ? moment(addressState?.address?.pickuptime, 'hh:mm a').toDate() : null);
								...
								<Controller
									...
									render={() => (
										<GooglePlacesAutocomplete
											placeholder={t('PICKUP_ADDRESS', 'Pickup address')}
										...
										<View style={styles.pinIcon}>
											<GPSButton
												...
												handleGPS={(data: any, detail: any) => {
													...
													if (googleInputDelivery?.current) {
														googleInputDelivery?.current?.setAddressText(data.deliveryaddress);
													}
												}}
												IconButton={<OIcon src={theme.images.general.pin} width={16} />}
												isIntGeoCoder
