...
const OrderTypeSelectorCourierUI = (props: OrderTypeSelectParams) => {
	const {
		navigation,
	...
	return (
		...
		<View style={{paddingHorizontal:20, marginTop:-20}}>
				<NavBar
						onActionLeft={() => handleUpdateOrderType()}
						btnStyle={{ paddingLeft: 0, width: 50 }}
						paddingTop={Platform.OS === 'ios' ? 10 : 0}
						style={{ paddingBottom: 0 }}
						title={t('CHOOSE_YOUR_ORDER_TYPE', 'Choose your order type')}
						titleAlign={'center'}
...
export const OrderTypeSelectorCourier = (props: any) => {

	const orderTypeProps = {
		...props,
		UIComponent: OrderTypeSelectorCourierUI,
